           ...
           <html lang="en">
             ...
             <body>
               <br>
               <h1 style="margin-left: 18px;"><b>Sundar Bun.</b></h1>
               <br><br>
               <div class="col-md-4 col-sm-4 fh5co-item-wrap" id="other">
                   <a class="fh5co-listing-item">
                       <center><img src="images/park.png" alt="Other" class="img-responsive"></center>
                       <div class="fh5co-listing-copy">
                       </div>
                   </a>
               </div>
               <div>
           <p  style="text-align: justify;font-size:18px;padding:12px;">The Sundarbans mangrove forest, one of the largest such forests in the world (140,000 ha), lies on the delta of the Ganges, Brahmaputra and Meghna rivers on the Bay of Bengal. It is adjacent to the border of India’s Sundarbans World Heritage site inscribed in 1987. </p>
...
• The area is known for its wide range of fauna, including 260 bird species, the Bengal tiger and other threatened species such as the estuarine crocodile and the Indian python.</p>
             ...
             <div>
              ...
              <table border="1" width="100%" style="text-align: center;font-size: 20px;">
                ...
                <?php
                   ...
                   $result= mysqli_query($mysqli,"select * from heritage where id=7");
               ...
               <script type="text/javascript">
                ...
                document.getElementById("i2").onclick = function () {
                  location.href = "https://goo.gl/maps/jzYe7WGmskguFtZ18";
                };
