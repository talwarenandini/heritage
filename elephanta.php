           ...
           <html lang="en">
             ...
             <body>
               <br>
               <h1 style="margin-left: 18px;"><b>Elephanta Caves</b></h1>
               <br><br>
               <div class="col-md-4 col-sm-4 fh5co-item-wrap" id="other">
                   <a class="fh5co-listing-item">
                       <center><img src="images/ELEFANTA CAVES.png" alt="Other" class="img-responsive"></center>
                       <div class="fh5co-listing-copy">
                       </div>
                   </a>
               </div>
               <div>
           <p  style="text-align: justify;font-size:18px;padding:12px;">The 'City of Caves', on an island in the Sea of Oman close to Bombay, contains a collection of rock art linked to the cult of Shiva. Here, Indian art has found one of its most perfect expressions, particularly the huge high reliefs in the main cave </p>
             <p  style="text-align: justify;font-size:18px;padding:12px;"> 
             • The rock-cut Elephanta Caves were constructed about the mid-5th to 6th centuries AD. <br>
• The most important among the caves is the great Cave 1, which measures 39 metres from the front entrance to the back.    </p>
<audio src="audio/elephanta.mpeg" controls >
                <embed src="audio/elephanta.mpeg" type="audio" loop="false" autostart="false">
               </audio>
             ...
             <div>
              ...
              <table border="1" width="100%" style="text-align: center;font-size: 20px;">
                ...
                <?php
                   ...
                   $result= mysqli_query($mysqli,"select * from heritage where id=6");
