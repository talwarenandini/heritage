           ...
           <html lang="en">
             ...
             <body>
               <br>
               <h1 style="margin-left: 18px;"><b>Mumbai CST .</b></h1>
               <br><br>
               <div class="col-md-4 col-sm-4 fh5co-item-wrap" id="other">
                   <a class="fh5co-listing-item">
                       <center><img src="images/CST MUMBAI.jpg" alt="Other" class="img-responsive"></center>
                       <div class="fh5co-listing-copy">
                       </div>
                   </a>
               </div>
               <div>
           <p  style="text-align: justify;font-size:18px;padding:12px;">The Chhatrapati Shivaji Terminus, formerly known as Victoria Terminus Station, in Mumbai, is an outstanding example of Victorian Gothic Revival architecture in India, blended with themes deriving from Indian traditional architecture.
 </p>
             <p  style="text-align: justify;font-size:18px;padding:12px;"> 
             • It was built by British architect F. W. Stevens and became the symbol of Bombay as the ‘Gothic City’ and the major international mercantile port of India. <br>
• It's a amezing combination of British architecture with Indian architecture.</p>
